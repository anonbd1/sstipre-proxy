...
<head>
    ...
    <title> ⚡ CVV AND CCN CHECKER ⚡</title>
    <!-- CSS -->
...
<body class="content-dark">
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">⚡ CVV AND CCN CHECKER ⚡</h6>
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title">CVV And CCN CHECKER</h5>
                        ...
                        <div class="widget-body">
                            <button type="button" id="sh_apr" onclick="Mudaestado('aprovadasapp');" class="btn btn-success" style="background-color: #4b359d; border-color:#fff ">APPROVED [ <span id="aprovada_conta">0</span> ]</button>
                            ...
                            <button type="button" id="sh_rep" onclick="Mudaestado('reprovadasapp');" class="btn btn-danger"  style="background-color: #ce0303; border-color:#fff">DECLINED [ <span id="reprovada_conta">0</span> ]</button>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <textarea id="lista" placeholder="0000000000000000|00|0000|000" class="form-control" style="resize:none;outline:none;width:250px; height:150px;"></textarea><br>

                                    <button type="button" id="iniciar"  onclick="start()" class="btn btn-success" style="background-color: #4b359d; border-color:#ffff">Start</button> 
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <button type="button" onclick="stop()" id="parar" class="btn btn-danger" style="background-color: #ce0303; border-color:#ffff" >Stop</button>
                                   ...
                                   Time: <span class="badge badge-primary" id="horas">NULL</span>
                                    ...
                                    <p>Edited By :  <a target="_BLANK" href="https://t.me/India_DragonMaster">⚡★彡🇮🇳🐉𝑫𝒓𝒂𝒈𝒐𝒏#𝑴𝒂𝒔𝒕𝒆𝒓🇮🇳彡★⚡</a></p>
    ...
    <footer>
        <center>
            CLICK QUICK <a href="https://t.me/India_DragonMaster">Telegram chat</a>
        </center>
    </footer>
    </div>
    <!--/ #wrapper -->
